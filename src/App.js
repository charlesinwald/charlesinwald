...
function EmailButton(props) {
  ...
  return (
    <Button
      className={props.classes.EmailButton}
      onClick={async () => {
    ...
    >
      {copied ? "  copied to clipboard  " : "charlesinwald@gmail.com"}{" "}
      <MailOutlineIcon className={props.classes.SocialButtonIcon} />
    </Button>
  );
}
...
function WorkExperienceCard(props) {
  const descriptionList = props.description.map((item) => (
    <Typography style={{ marginTop: ".5rem" }}>{item}</Typography>
  ));
  return (
    <Card className={props.classes.resumeActivity}>
      <CardActionArea>
        <CardMedia
          image={props.image}
...
function App() {
  ...
  let CiamtisDescription = [
    "Developed crowdsensing mobile app for pavement monitoring using mobile\n" +
      "camera and accelerometer in Java",
    "Prototyped Python cryptocurrency for distributed computer vision\n" +
      "processing and crowdsensing incentive mechanism",
  ];
  let TaDescription = [
    "Mentored over 80 students on app development projects\n" +
      "written in Java, JavaScript, and SQL",
    "Redesigned course curriculum to integrate software design patterns;\n" +
      "recorded instructional videos",
    "Held office hours to assist students in solving technical and conceptual\n" +
      "issues",
  ];
  let EyDescription = [
  ...
  let OlympusDescription = [
    "Built custom software for image and voice recognition on augmented reality\n" +
      "glasses for medical use",
    "Full-stack application built with Node.js and Google Cloud Platform backend,\n" +
      ...
      <Grid container spacing={3} fluid className={classes.LandingGrid}>
        <Grid item xs={8} style={{ flexGrow: 1 }}>
          ...
          <div className={classes.LandingBodyTextWrapper}>
            <motion.h1
              className={classes.LandingBodyText}
              animate={{ scale: 1.3 }}
            >
              A full stack software developer with demonstrated expertise in
      ...
      <Grid container spacing={3} fluid className={classes.ResumeGrid}>
        <section className="resume-container">
          ...
          <Grid container fluid className="resume-inner-container">
            ...
            <WorkExperienceCard
              ...
              description={CiamtisDescription}
              image="ciamtis.png"
            />
            <WorkExperienceCard
              classes={classes}
            ...
            <WorkExperienceCard
              classes={classes}
              title="EY, Prague, Czech Republic"
            ...
            <WorkExperienceCard
              ...
              image="olympus.png"
              description={OlympusDescription}
            />
          </Grid>
          <motion.h1
            className="heading"
          ...
          <Grid
            container
            fluid
            className="education-inner-container"
            justify="center"
          >
            <WorkExperienceCard
              classes={classes}
              ...
              image="lehigh.png"
              description={MastersDescription}
            />
            <WorkExperienceCard
              classes={classes}
              title="Lehigh University"
              position="B.S Computer Science and Business"
              image="lehigh.png"
              description={CSBDescription}
            />
          </Grid>
        </section>
        <Grid container spacing={3} fluid className={classes.ContactGrid}>
          <section className="contact-container">
            ...
            >
              LinkedIn
              <LinkedInIcon className={classes.SocialButtonIcon} />
            </Button>
